...
func SignCompact(key *thtec.PrivateKey, hash []byte,
...
func RecoverCompact(signature, hash []byte) (*thtec.PublicKey, bool, error) {
...
// and BIP0062.
func Sign(key *thtec.PrivateKey, hash []byte) *Signature {
