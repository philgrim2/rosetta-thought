...
type Message interface {
	ThtDecode(io.Reader, uint32, MessageEncoding) error
	ThtEncode(io.Writer, uint32, MessageEncoding) error
	Command() string
...
type messageHeader struct {
	magic    chaincfg.NetMagic // 4 bytes
...
func WriteMessageN(w io.Writer, msg Message, pver uint32, btcnet chaincfg.NetMagic) (int, error) {
...
func WriteMessage(w io.Writer, msg Message, pver uint32, btcnet chaincfg.NetMagic) error {
...
func WriteMessageWithEncodingN(w io.Writer, msg Message, pver uint32,
	btcnet chaincfg.NetMagic, encoding MessageEncoding) (int, error) {
	...
	var bw bytes.Buffer
	err := msg.ThtEncode(&bw, pver, encoding)
	if err != nil {
...
func ReadMessageWithEncodingN(r io.Reader, pver uint32, btcnet chaincfg.NetMagic,
	...
	// MsgVersion ThtDecode function requires it.
	pr := bytes.NewBuffer(payload)
	err = msg.ThtDecode(pr, pver, enc)
	if err != nil {
		return totalBytes, nil, nil, err
	}
...
func ReadMessageN(r io.Reader, pver uint32, btcnet chaincfg.NetMagic) (int, Message, []byte, error) {
...
func ReadMessage(r io.Reader, pver uint32, btcnet chaincfg.NetMagic) (Message, []byte, error) {
