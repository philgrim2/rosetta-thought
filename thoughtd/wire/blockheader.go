...
func (h *BlockHeader) ThtDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
...
func (h *BlockHeader) ThtEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
