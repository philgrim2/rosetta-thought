...
func (msg *MsgGetCFHeaders) ThtDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgGetCFHeaders) ThtEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
