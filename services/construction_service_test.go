...
func TestConstructionServiceTestnet(t *testing.T) {
	...
	metadata := &constructionMetadata{
		ScriptPubKeys: []*thought.ScriptPubKey{
			{
				ASM:          "OP_DUP OP_HASH160 4dcd59a0e06d16b4004e6b5779a9a2f8bb9e29da OP_EQUALVERIFY OP_CHECKSIG",
				Hex:          "76a9144dcd59a0e06d16b4004e6b5779a9a2f8bb9e29da88ac",
				RequiredSigs: 1,
				Type:         "pubkeyhash",
				Addresses: []string{
	...
	// Test Payloads
	unsignedRaw := "" // nolint
	...
	signingPayload := &types.SigningPayload{
		Bytes: forceHexDecode(
			t,
			"3fd0fdb676cc425cdd1fcfa76e5d5c0f8534b64a6e5e82bf007aa0b60cac2b11",
		),
		AccountIdentifier: &types.AccountIdentifier{
			Address: "kyw8MaocLYCniZ3NnJqNST3qtZNygLSiCC",
		},
