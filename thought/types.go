...
const (
	// Blockchain is Thought.
	Blockchain string = "Thought"
	...
	// NotionsInThought is the number of
	// Notions in 1 THT (10^8).
	NotionsInThought = 100000000
	...
	// Thought operations because anything
	...
	// of any transaction hash in Thought.
	TransactionHashLength = 64

	// NullData is returned by thoughtd
...
var (
	...
	MainnetGenesisBlockIdentifier = &types.BlockIdentifier{
		Hash: "00000000917e049641189c33d6b1275155e89b7b498b3b4f16d488f60afe513b",
	}
...
// of a Thought transaction that must be satisfied to spend
// the output.
...
// Thought transaction that satisfies the ScriptPubKey
...
// BlockchainInfo is information about the Thought network.
...
// Block is a raw Thought block (with verbosity == 2).
type Block struct {
...
// Transaction is a raw Thought transaction.
...
// Input is a raw input in a Thought transaction.
type Input struct {
...
// Output is a raw output in a Thought transaction.
type Output struct {
...
// metadata from Thought inputs and outputs.
