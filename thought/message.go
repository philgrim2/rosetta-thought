...
func WriteMessageN(w io.Writer, msg Message, pver uint32, btcnet NetMagic) (int, error) {
...
func WriteMessage(w io.Writer, msg Message, pver uint32, btcnet NetMagic) error {
...
func WriteMessageWithEncodingN(w io.Writer, msg Message, pver uint32,
	btcnet NetMagic, encoding MessageEncoding) (int, error) {
...
func ReadMessageWithEncodingN(r io.Reader, pver uint32, btcnet NetMagic,
...
func ReadMessageN(r io.Reader, pver uint32, btcnet NetMagic) (int, Message, []byte, error) {
...
func ReadMessage(r io.Reader, pver uint32, btcnet NetMagic) (Message, []byte, error) {
