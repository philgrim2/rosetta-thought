...
// ThtDecode decodes r using the thought protocol encoding into the receiver.
// This is part of the Message interface implementation.
// See Deserialize for decoding transactions stored to disk, such as in a
// database, as opposed to decoding transactions from the wire.
func (msg *MsgTx) ThtDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count == TxFlagMarker && enc == WitnessEncoding {
		...
		if flag[0] != WitnessFlag {
			...
			return messageError("MsgTx.ThtDecode", str)
		}
...
// the Version field in the transaction.  This function differs from ThtDecode
// in that ThtDecode decodes from the bitcoin wire protocol as it was sent
...
func (msg *MsgTx) Deserialize(r io.Reader) error {
	...
	// a result, make use of ThtDecode.
	return msg.ThtDecode(r, 0, WitnessEncoding)
}
...
func (msg *MsgTx) DeserializeNoWitness(r io.Reader) error {
	return msg.ThtDecode(r, 0, BaseEncoding)
}
...
func (msg *MsgTx) ThtEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
...
// the transaction.  This function differs from ThtEncode in that ThtEncode
...
func (msg *MsgTx) Serialize(w io.Writer) error {
	// At the current time, there is no difference between the wire encoding
	// at protocol version 0 and the stable long-term storage format.  As
	// a result, make use of ThtEncode.
	//
	// Passing a encoding type of WitnessEncoding to ThtEncode for MsgTx
	...
	// BIP0144.
	return msg.ThtEncode(w, 0, WitnessEncoding)
}
...
func (msg *MsgTx) SerializeNoWitness(w io.Writer) error {
	return msg.ThtEncode(w, 0, BaseEncoding)
}
