...
func (msg *MsgVerAck) ThtDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	return nil
}

// ThtEncode encodes the receiver to w using the bitcoin protocol encoding.
// This is part of the Message interface implementation.
func (msg *MsgVerAck) ThtEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	return nil
}
