...
const DefaultUserAgent = "/rosetta_thought:0.18.2/"
...
func (msg *MsgVersion) ThtDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	buf, ok := r.(*bytes.Buffer)
	if !ok {
		return fmt.Errorf("MsgVersion.ThtDecode reader is not a " +
			"*bytes.Buffer")
	}
...
// This is part of the Message interface implementation.
func (msg *MsgVersion) ThtEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
