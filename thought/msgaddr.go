...
func (msg *MsgAddr) ThtDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count > MaxAddrPerMsg {
		...
		return messageError("MsgAddr.ThtDecode", str)
	}
...
// This is part of the Message interface implementation.
func (msg *MsgAddr) ThtEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	...
	if pver < MultipleAddressVersion && count > 1 {
		...
		return messageError("MsgAddr.ThtEncode", str)
