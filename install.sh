...
usage() {
  this=$1
  cat <<EOF
$this: download pre-compiled Docker images for thoughtnetwork/rosetta-thought 
...
execute() {
  ...
  docker tag "rosetta-thought:${TAG}" "rosetta-thought:latest"
  log_info "loaded rosetta-thought:${TAG} and tagged as rosetta-thought:latest"
  rm -rf "${tmpdir}"
